...
#data <- read_excel("C:/Users/DeepakArun/Desktop/input.xlsx")

data <- read.csv("C:/Users/DeepakArun/Desktop/TWC New/Data/MMM_Model1_interaction_inputs_base_and_organic.csv")
