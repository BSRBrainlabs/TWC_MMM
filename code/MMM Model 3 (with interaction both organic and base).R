...
data <- read_excel("C:/Users/DeepakArun/Desktop/Data/input3.xlsx")

#data <- read.csv("C:/Users/DeepakArun/Desktop/MMM_Model1_interaction_inputs_base_and_organic.csv")
...
InputCollect <- robyn_inputs(
  ...
  dep_var = "App_New_Visits", # there should be only one dependent variable
  ...
  context_vars = c('Preference',
                   ...
                   'New_Visits_Critical_Event_Flag',
