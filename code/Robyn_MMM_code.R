...
#                  'SocialEng_Instagram_Total_Engagements'
# )
# ###################### INPUT FOR MODEL 3 ITERATION 4 (OVERALL VISITS AS TARGET) ####################################
...
# ###################### INPUT FOR MODEL 3 ITERATION 5 (OVERALL VISITS AS TARGET) ####################################
...
InputCollect <- robyn_inputs(
  ...
  dep_var = "Overall_Product_Visits", # there should be only one dependent variable
  #"Overall_Web_Visits, #"Total_App_Installs (Select either of these target variable depending on our usecase)
